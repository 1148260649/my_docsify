...
![JVM运行时数据区域](../../img/java/jvm/JVM运行时数据区域.png)

**JDK 1.8 ：**

![Java运行时数据区域JDK1.8](../../img/java/jvm/Java运行时数据区域JDK1.8.png)
...
![对象的创建过程](../../img/java/jvm/对象的创建过程.png)
...
![内存分配的两种方式](../../img/java/jvm/内存分配的两种方式.png)
...
![堆内存常见分配策略](../../img/java/jvm/堆内存常见分配策略.jpg)
...
![可达性分析算法](../../img/java/jvm/可达性分析算法.jpg)
...
![垃圾收集算法分类](../../img/java/jvm/垃圾收集算法分类.jpg)
...
![标记-整理算法](../../img/java/jvm/标记-整理算法.jpg)
...
![Serial收集器](../../img/java/jvm/Serial收集器.jpg)
...
**新生代采用复制算法，老年代采用标记-整理算法。**  
![ParNew收集器](../../img/java/jvm/ParNew收集器.jpg)
...
![CMS垃圾收集器](../../img/java/jvm/CMS垃圾收集器.jpg)
...
![类文件字节码结构组织示意图](../../img/java/jvm/类文件字节码结构组织示意图.png)
...
![ClassLoader](../../img/java/jvm/ClassLoader.png)
