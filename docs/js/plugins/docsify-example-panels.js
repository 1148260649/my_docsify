...
!(function () {
  ...
  window &&
    ...
    (window.$docsify.panels.version = "1.1.0"),
    (window.$docsify.plugins = [].concat(function (e, a) {
      var n = !1;
      e.beforeEach(function (e) {
        return (
          (n = g.panelWrapperMarkup.test(e)) &&
            (e = (function (p) {
              for (
                var e,
                  a,
                  n = p.match(g.codeMarkup) || [],
                  i = n.map(function (e, a) {
                    var n = "\x3c!-- "
                      .concat(x, " CODEBLOCK")
                      .concat(a, " --\x3e");
                ...
                if (l)
                  for (
                    t = "\x3c!-- "
                      .concat(x, ' <div class="')
                      .concat([u.panelWrapper].join(" "), '"> --\x3e'),
                      r = "\n"
                        .concat(o, "\x3c!-- ")
                        .concat(x, " </div> --\x3e");
                    null !== (a = g.panelMarkup.exec(d));
                    ...
                    d = d.replace(
                      ...
                      [
                        "\n"
                          .concat(o, "\x3c!-- ")
                          .concat(x, ' <div class="')
                          .concat([u.panelContainer, m].join(" "), '"> --\x3e'),
                        "\n\n".concat(o).concat(f),
                        "\n\n"
                          .concat(o, "\x3c!-- ")
                          .concat(x, " </div> --\x3e"),
